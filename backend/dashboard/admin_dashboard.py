...
def void_transaction(transaction_id):
    ...
    try:
        ...
        # Only void Purchase transactions (not Load or already Voided)
        ...
        # Reverse the balance in Money Accounts sheet
        accounts_sheet = get_worksheet_with_retry("Money Accounts")
        ...
        # Find Balance column index in Money Accounts (column 3 typically)
        ...
        # Update transaction type to Voided
