...
struct QRScannerView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> ScannerViewController {
        ...
        viewController.onScannerFailure = context.coordinator.onScannerFailure
        return viewController
    }

    func updateUIViewController(_ uiViewController: ScannerViewController, context: Context) {
        uiViewController.delegate = context.coordinator
        uiViewController.onScannerFailure = context.coordinator.onScannerFailure
    }
...
final class ScannerViewController: UIViewController {
    ...
    private func setupSession() {
        guard let delegate else {
            reportScannerFailure("QR scanner setup failed because scanner delegate is unavailable. Tap Retry to try again.")
            return
        }
