...
- [x] **T02: Redesign Budget, Receipt, and Lost-Card views with stitch primitives, accessibility markers, and scope-clean controls** `est:1h 40m`
...
- [x] **T03: Add one-command S04 verifier and manual acceptance checklist for demo closure** `est:1h`
