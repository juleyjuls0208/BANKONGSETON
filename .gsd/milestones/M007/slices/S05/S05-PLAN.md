...
- [ ] **T01: Implement local settings persistence contract for accent and personal info** `est:2h`
...
- [ ] **T02: Wire reactive accent and persisted display name into shared app surfaces** `est:2h`
