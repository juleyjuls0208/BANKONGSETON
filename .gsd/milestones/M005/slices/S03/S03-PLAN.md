...
- [ ] **T02: Implement `qr/confirm` debit + `qr-generate` cashier route + `qr_payment` socket handler** `est:1h`
...
- [ ] **T03: Write verify script, add SERVER_URL to .env.example and docs/DEPLOY.md** `est:20m`
